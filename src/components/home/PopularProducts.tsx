...
export default async function PopularProducts() {
    // Получаем 6 самых популярных товаров (по просмотрам или по isFeatured)
    ...
    return (
        <section className="py-20 bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-950">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold mb-10 text-zinc-900 dark:text-zinc-100">
                    Популярные товары
                </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {products.map((product) => (
                        <div
                            key={product.id}
                            className="group relative rounded-2xl overflow-hidden bg-white dark:bg-zinc-800 shadow-md hover:shadow-xl transition-all duration-300"
                        >
